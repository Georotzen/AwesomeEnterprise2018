...
public class CacheConfiguration {
    ...
    public HazelcastInstance hazelcastInstance(JHipsterProperties jHipsterProperties) {
        ...
        HazelcastInstance hazelCastInstance = Hazelcast.getHazelcastInstanceByName("AwesomeEnterprise2018");
        if (hazelCastInstance != null) {
            log.debug("Hazelcast already initialized");
            return hazelCastInstance;
        }
        Config config = new Config();
        config.setInstanceName("AwesomeEnterprise2018");
        ...
        config.getMapConfigs().put("io.github.jhipster.georotzen.domain.*", initializeDomainMapConfig(jHipsterProperties));
